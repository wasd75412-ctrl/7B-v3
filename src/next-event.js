...
export function calculateCombinedPerPersonFee(rentalTotal,shuttleTotal,participantCount){
  const rental=Math.max(0,Number(rentalTotal)||0),shuttles=Math.max(0,Number(shuttleTotal)||0),participants=positiveWholeNumber(participantCount);
